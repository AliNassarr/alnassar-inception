# [42 EvalHub](https://www.42evalhub.com/) - Inception Evaluation Scale

[Home](https://www.42evalhub.com/home) | [Common Core](https://www.42evalhub.com/common-core) | [Specs](https://www.42evalhub.com/specs)

← Back **inception**  
Scale for project [Inception](https://projects.intra.42.fr/projects/inception)  
...
- [subject.pdf](https://cdn.intra.42.fr/pdf/pdf/219529/en.subject.pdf)
...
- Before starting the evaluation, run this command in the terminal:
  ...
  ```
- Then, run the following command to remove the host-mapped volume data directory (replace with the login of the evaluated student):
  ```bash
...
- Ensure that the WordPress website is properly installed and configured (you shouldn't see the WordPress Installation page). To access it, open [https://login.42.fr](https://login.42.fr/) in your browser, where login is the login of the evaluated learner. You shouldn't be able to access the site via [http://login.42.fr](http://login.42.fr/). If something doesn't work as expected, the evaluation process ends now.
...
- Open [https://login.42.fr/](https://login.42.fr/) in your browser, where login is the login of the evaluated learner. The displayed page must be the configured WordPress website (you shouldn't see the WordPress Installation page).
